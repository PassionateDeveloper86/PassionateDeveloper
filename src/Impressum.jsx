...
const Impressum = (props) => {
  return (
    <div className="impressumArea">
      <div>
       
        <Popup
          trigger={ <div style={{cursor:"pointer"}}>
            {props.getTranslation("impress")}
            </div> }
          modal
          closeOnDocumentClick
        >
          <div className="impressumText">
            <h1 className="adsimple-321199483">Impressum</h1>
            <p className="adsimple-321199483">Informationspflicht laut § 5 TMG.</p>
            <p className="adsimple-321199483">Rene Koch, <br />Achtert Wallen 14, <br />26607 Aurich, <br />Deutschland</p>
            <p className="adsimple-321199483">
              <strong>UID-Nummer:</strong> DE201/4105/1204 <br />
            </p>
            <p className="adsimple-321199483">
              <strong>Tel.:</strong> 0178 / 856 26651<br />
              
              <strong>E-Mail:</strong> <a href="mailto:info@passionate-developer.com">info@passionate-developer.com</a>
            </p>
            <p className="adsimple-321199483">
              <strong>Berufsbezeichnung:</strong> Software-Entwickler</p>
            <h2 className="adsimple-321199483">EU-Streitschlichtung</h2>
...
Verbraucher haben die Möglichkeit, Beschwerden an die Online Streitbeilegungsplattform der Europäischen Kommission unter http://ec.europa.eu/odr?tid=321199483 zu richten. Die dafür notwendigen Kontaktdaten finden Sie oberhalb in unserem Impressum.</p>
            <p>Wir möchten Sie jedoch darauf hinweisen, dass wir nicht bereit oder verpflichtet sind, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</p>
            <h2 className="adsimple-321199483">Haftung für Inhalte dieser Website</h2>import Popup from "reactjs-popup";
<p>Wir entwickeln die Inhalte dieser Webseite ständig weiter und bemühen uns korrekte und aktuelle Informationen bereitzustellen. Laut Telemediengesetz (TMG) §7 (1) sind wir als Diensteanbieter für eigene Informationen, die wir zur Nutzung bereitstellen, nach den allgemeinen Gesetzen verantwortlich. Leider können wir keine Haftung für die Korrektheit aller Inhalte auf dieser Webseite übernehmen, speziell für jene die seitens Dritter bereitgestellt wurden. Als Diensteanbieter im Sinne der §§ 8 bis 10 sind wir nicht verpflichtet, die von ihnen übermittelten oder gespeicherten Informationen zu überwachen oder nach Umständen zu forschen, die auf eine rechtswidrige Tätigkeit hinweisen.</p>
            ...
            <h2 className="adsimple-321199483">Haftung für Links auf dieser Website</h2>
            <p>Unsere Webseite enthält Links zu anderen Webseiten für deren Inhalt wir nicht verantwortlich sind. Haftung für verlinkte Websites besteht für uns nicht, da wir keine Kenntnis rechtswidriger Tätigkeiten hatten und haben, uns solche Rechtswidrigkeiten auch bisher nicht aufgefallen sind und wir Links sofort entfernen würden, wenn uns Rechtswidrigkeiten bekannt werden.</p>
            <p>Wenn Ihnen rechtswidrige Links auf unserer Website auffallen, bitte wir Sie uns zu kontaktieren. Sie finden die Kontaktdaten im Impressum.</p>
            <h2 className="adsimple-321199483">Urheberrechtshinweis</h2>
            ...
            <h2 className="adsimple-321199483">Bildernachweis</h2>
            <p>Die Bilder, Fotos und Grafiken auf dieser Webseite sind urheberrechtlich geschützt.</p>
            <p>Die Bilderrechte liegen bei den folgenden Fotografen und Unternehmen:</p>
            <ul className="adsimple-321199483">
              <li className="adsimple-321199483">Fotograf Mustermann</li>
            </ul>
            <h1 className="adsimple-321199483">Datenschutzerklärung</h1>
            <h2 className="adsimple-321199483">Datenschutz</h2>
            <p>Wir haben diese Datenschutzerklärung (Fassung 01.08.2020-321199483) verfasst, um Ihnen gemäß der Vorgaben der Datenschutz-Grundverordnung (EU) 2016/679 zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.</p>
            <p>Leider liegt es in der Natur der Sache, dass diese Erklärungen sehr technisch klingen, wir haben uns bei der Erstellung jedoch bemüht die wichtigsten Dinge so einfach und klar wie möglich zu beschreiben.</p>
            <h2 className="adsimple-321199483">Automatische Datenspeicherung</h2>
            <p>Wenn Sie heutzutage Webseiten besuchen, werden gewisse Informationen automatisch erstellt und gespeichert, so auch auf dieser Webseite.</p>
            <p>Wenn Sie unsere Webseite so wie jetzt gerade besuchen, speichert unser Webserver (Computer auf dem diese Webseite gespeichert ist) automatisch Daten wie</p>
            <ul className="adsimple-321199483">
              <li className="adsimple-321199483">die Adresse (URL) der aufgerufenen Webseite</li>
              <li className="adsimple-321199483">Browser und Browserversion</li>
              <li className="adsimple-321199483">das verwendete Betriebssystem</li>
              <li className="adsimple-321199483">die Adresse (URL) der zuvor besuchten Seite (Referrer URL)</li>
              <li className="adsimple-321199483">den Hostname und die IP-Adresse des Geräts von welchem aus zugegriffen wird</li>
              <li className="adsimple-321199483">Datum und Uhrzeit</li>
            </ul>
            ...
            <h2 className="adsimple-321199483">Cookies</h2>
            <p>Unsere Website verwendet HTTP-Cookies um nutzerspezifische Daten zu speichern.<br />
Im Folgenden erklären wir, was Cookies sind und warum Sie genutzt werden, damit Sie die folgende Datenschutzerklärung besser verstehen.</p>
            <h3 className="adsimple-321199483">Was genau sind Cookies?</h3>
            ...
            <ul className="adsimple-321199483">
              <li className="adsimple-321199483">Name: _ga</li>
              <li className="adsimple-321199483">Ablaufzeit: 2 Jahre</li>
              <li className="adsimple-321199483">Verwendung: Unterscheidung der Webseitenbesucher</li>
              <li className="adsimple-321199483">Beispielhafter Wert: GA1.2.1326744211.152321199483</li>
            </ul>
            <p>Ein Browser sollte folgende Mindestgrößen unterstützen:</p>
            <ul className="adsimple-321199483">
              <li className="adsimple-321199483">Ein Cookie soll mindestens 4096 Bytes enthalten können</li>
              <li className="adsimple-321199483">Pro Domain sollen mindestens 50 Cookies gespeichert werden können</li>
              <li className="adsimple-321199483">Insgesamt sollen mindestens 3000 Cookies gespeichert werden können</li>
            </ul>
            <h3 className="adsimple-321199483">Welche Arten von Cookies gibt es?</h3>
            ...
            <p>
              <strong className="adsimple-321199483">Unbedingt notwendige Cookies<br />
            ...
            <p>
              <strong className="adsimple-321199483">Funktionelle Cookies<br />
            ...
            <p>
              <strong className="adsimple-321199483">Zielorientierte Cookies<br />
              </strong>Diese Cookies sorgen für eine bessere Nutzerfreundlichkeit. Beispielsweise werden eingegebene Standorte, Schriftgrößen oder Formulardaten gespeichert.</p>
            <p>
              <strong className="adsimple-321199483">Werbe-Cookies<br />
              </strong>Diese Cookies werden auch Targeting-Cookies genannt. Sie dienen dazu dem User individuell angepasste Werbung zu liefern. Das kann sehr praktisch, aber auch sehr nervig sein.</p>
            <p>Üblicherweise werden Sie beim erstmaligen Besuch einer Webseite gefragt, welche dieser Cookiearten Sie zulassen möchten. Und natürlich wird diese Entscheidung auch in einem Cookie gespeichert.</p>
            <h3 className="adsimple-321199483">Wie kann ich Cookies löschen?</h3>
            ...
            <p>
              Internet Explorer: Löschen und Verwalten von Cookies            </p>
            <p>
            <p>Wenn Sie mehr über Cookies wissen möchten und technischen Dokumentationen nicht scheuen, empfehlen wir https://tools.ietf.org/html/rfc6265, dem Request for Comments der Internet Engineering Task Force (IETF) namens &#8220;HTTP State Management Mechanism&#8221;.</p>
              Microsoft Edge: Löschen und Verwalten von Cookies
            </p>
            <p>Falls Sie grundsätzlich keine Cookies haben wollen, können Sie Ihren Browser so einrichten, dass er Sie immer informiert, wenn ein Cookie gesetzt werden soll. So können Sie bei jedem einzelnen Cookie entscheiden, ob Sie das Cookie erlauben oder nicht. Die Vorgangsweise ist je nach Browser verschieden. Am besten ist es Sie suchen die Anleitung in Google mit dem Suchbegriff “Cookies löschen Chrome” oder &#8220;Cookies deaktivieren Chrome&#8221; im Falle eines Chrome Browsers oder tauschen das Wort &#8220;Chrome&#8221; gegen den Namen Ihres Browsers, z.B. Edge, Firefox, Safari aus.</p>
            <h3 className="adsimple-321199483">Wie sieht es mit meinem Datenschutz aus?</h3>
            <p>Seit 2009 gibt es die sogenannten „Cookie-Richtlinien“. Darin ist festgehalten, dass das Speichern von Cookies eine Einwilligung von Ihnen verlangt. Innerhalb der EU-Länder gibt es allerdings noch sehr unterschiedliche Reaktionen auf diese Richtlinien. In Deutschland wurden die Cookie-Richtlinien nicht als nationales Recht umgesetzt. Stattdessen erfolgte die Umsetzung dieser Richtlinie weitgehend in § 15 Abs.3 des Telemediengesetzes (TMG).</p>
            <p>Wenn Sie mehr über Cookies wissen möchten und technischen Dokumentationen nicht scheuen, empfehlen wir, dem Request for Comments der Internet Engineering Task Force (IETF) namens &#8220;HTTP State Management Mechanism&#8221;.</p>
            <h2 className="adsimple-321199483">Rechte laut Datenschutzgrundverordnung</h2>
            <p>Ihnen stehen laut den Bestimmungen der DSGVO grundsätzlich die folgende Rechte zu:</p>
            <ul className="adsimple-321199483">
              <li className="adsimple-321199483">Recht auf Berichtigung (Artikel 16 DSGVO)</li>
              <li className="adsimple-321199483">Recht auf Löschung („Recht auf Vergessenwerden“) (Artikel 17 DSGVO)</li>
              <li className="adsimple-321199483">Recht auf Einschränkung der Verarbeitung (Artikel 18 DSGVO)</li>
              <li className="adsimple-321199483">Recht auf Benachrichtigung &#8211; Mitteilungspflicht im Zusammenhang mit der Berichtigung oder Löschung personenbezogener Daten oder der Einschränkung der Verarbeitung (Artikel 19 DSGVO)</li>
              <li className="adsimple-321199483">Recht auf Datenübertragbarkeit (Artikel 20 DSGVO)</li>
              <li className="adsimple-321199483">Widerspruchsrecht (Artikel 21 DSGVO)</li>
              <li className="adsimple-321199483">Recht, nicht einer ausschließlich auf einer automatisierten Verarbeitung — einschließlich Profiling — beruhenden Entscheidung unterworfen zu werden (Artikel 22 DSGVO)</li>
            </ul>
            ...
            <h2 className="adsimple-321199483">Auswertung des Besucherverhaltens</h2>
            ...
            <h2 className="adsimple-321199483">Google Fonts Datenschutzerklärung</h2>
            ...
            <h3 className="adsimple-321199483">Was sind Google Fonts?</h3>
            <p>Google Fonts (früher Google Web Fonts) ist ein Verzeichnis mit über 800 Schriftarten, die Google seinen Nutzern kostenlos zu Verfügung stellt.</p>
            ...
            <h3 className="adsimple-321199483">Warum verwenden wir Google Fonts auf unserer Webseite?</h3>
            ...
            <h3 className="adsimple-321199483">Welche Daten werden von Google gespeichert?</h3>
            ...
            <h3 className="adsimple-321199483">Wie lange und wo werden die Daten gespeichert?</h3>
            ...
            <h3 className="adsimple-321199483">Wie kann ich meine Daten löschen bzw. die Datenspeicherung verhindern?</h3>
            <p>Jene Daten, die Google für einen Tag bzw. ein Jahr speichert können nicht einfach gelöscht werden. Die Daten werden beim Seitenaufruf automatisch an Google übermittelt. Um diese Daten vorzeitig löschen zu können, müssen Sie den Google-Support auf https://support.google.com/?hl=de&amp;tid=321199483 kontaktieren. Datenspeicherung verhindern Sie in diesem Fall nur, wenn Sie unsere Seite nicht besuchen.</p>
            <p>Anders als andere Web-Schriften erlaubt uns Google uneingeschränkten Zugriff auf alle Schriftarten. Wir können also unlimitiert auf ein Meer an Schriftarten zugreifen und so das Optimum für unsere Webseite rausholen. Mehr zu Google Fonts und weiteren Fragen finden Sie auf https://developers.google.com/fonts/faq?tid=321199483. Dort geht zwar Google auf datenschutzrelevante Angelegenheiten ein, doch wirklich detaillierte Informationen über Datenspeicherung sind nicht enthalten. Es ist relativ schwierig, von Google wirklich präzise Informationen über gespeicherten Daten zu bekommen.</p>
            ...
            <h2 className="adsimple-321199483">Google Fonts Lokal Datenschutzerklärung</h2>
            ...
            <p>Anders als andere Web-Schriften erlaubt uns Google uneingeschränkten Zugriff auf alle Schriftarten. Wir können also unlimitiert auf ein Meer an Schriftarten zugreifen und so das Optimum für unsere Webseite rausholen. Mehr zu Google Fonts und weiteren Fragen finden Sie auf
              https://developers.google.com/fonts/faq?tid=321199483.</p>
          Kontaktformular
          <br /><br />
            Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.
            <br />
            Die eingegebenen Daten werden NICHT in einer Datenbank gespeichert und nur benutzt um eine EMail zu generieren, diese wird automatisiert nach 7 Tagen gelöscht.<br />
          </div>
        </Popup>
